...
<div class="sm-modal" id="manageStudyMaterialsModal">
    <div class="sm-modal-backdrop" data-close-modal></div>
    <div class="sm-modal-content sm-manage-modal-content" role="dialog" aria-modal="true" aria-labelledby="sm-manage-title">
        <div class="sm-modal-header">
            <h3 id="sm-manage-title">My study materials</h3>
            <button class="sm-modal-close" data-close-modal>&times;</button>
        </div>
        <div class="sm-modal-body sm-manage-body">
